...
import com.tanvir.aws.image.upload.bucket.BucketName;
import com.tanvir.aws.image.upload.filestore.FileStore;
...
public class UserProfileService {
    ...
    public void uploadUserProfileImage(UUID userProfileId, MultipartFile file) {
        ...
        String path = String.format("%s/%s", BucketName.PROFILE_IMAGE.getBucketName(), user.getUserProfileId().toString());
